"""
This is a test file working with the real FastAPI server running on a randomly chosen free port.

refactor @test_real.py and move its fixtures into a new file conftest.py
"""
