...
When using `clibro` as a library, the host application is responsible for configuring the logging system. For more details, see the [logging documentation](logging.md).
...
For details on how to configure the application, please see the [configuration documentation](configuration.md).

## Code Style and Quality

This project uses a number of tools to enforce code style and quality.
