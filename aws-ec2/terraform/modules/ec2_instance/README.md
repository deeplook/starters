...
| <a name="input_key_name_prefix"></a> [key\_name\_prefix](#input\_key\_name\_prefix) | Prefix for the generated SSH key pair name. A random suffix will be added for uniqueness. | `string` | `"tf-key"` | no |
