...
| <a name="input_app_image_identifier"></a> [app\_image\_identifier](#input\_app\_image\_identifier) | The full URI of the Docker image in ECR (e.g., 123456789012.dkr.ecr.us-east-1.amazonaws.com/my-repo:latest). | `string` | `null` | no |
